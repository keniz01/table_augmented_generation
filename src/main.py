...
question="Can you show all album titles by artist Sizzla release on label Jet Star?"
...
try:
    ...
    context=df.to_markdown(tablefmt="grid")
except (Exception, psycopg.DatabaseError) as error:
	print('ERROR: ',error)
	raise error

prompt=ResponseSynthesizePrompt()
response=prompt.generate_response(context=context, question=question)
